...
* [UniK](https://github.com/solo-io/unik) ⭐ 2,826 | 🐛 51 | 🌐 Go | 📅 2023-04-27 - Unikernel compiler supporting a Firecracker, rump kernels, OSv, IncludeOS and MirageOS.
* [Solo5](https://github.com/Solo5/solo5) ⭐ 999 | 🐛 46 | 🌐 C | 📅 2026-09-19 - Middle-ware interfacing unikernels with the host systems.
